...
class unlock_fsm_zeroize_test extends uvm_test;
    `uvm_component_utils(unlock_fsm_zeroize_test)
    ...
    function new(string name = "unlock_fsm_zeroize_test", uvm_component parent = null);
    ...
    task run_phase(uvm_phase phase);
        ...
        seq = unlock_fsm_seq::type_id::create("seq");
        seq.start(seqr);
        #20; //short delay
