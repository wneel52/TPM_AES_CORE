...
class unlock_fsm_bad_k2_test extends uvm_test;
    `uvm_component_utils(unlock_fsm_bad_k2_test)
    ...
    function new(string name = "unlock_fsm_bad_k2_test", uvm_component parent = null);
    ...
    task run_phase(uvm_phase phase);
        unlock_fsm_bad_k2_seq seq;
        
        phase.raise_objection(this);
        
        seq = unlock_fsm_bad_k2_seq::type_id::create("seq");
        seq.start(seqr);
